  ...
  export const actions = {
    async fetchMinuteReports({ commit, dispatch }, params) {
      return await this.$axios
        .get("/api/v1/prepaid/minutes-report/", { params: params })
        .then(res => {
    ...
    async fetchMinuteReport({ commit }, payload) {
      return await this.$axios
        .get(`/api/v1/prepaid/minutes-report/${payload.id}/`)
        .then(res => {
    ...
    async saveMinuteReport({ commit }, payload) {
      let url = "/api/v1/prepaid/minutes-report/";
      try {
    ...
    async updatePlanDetail({ commit }, payload) {
      let url = `/api/v1/prepaid/minutes-report/${payload.id}/`;
      let method = "put";
