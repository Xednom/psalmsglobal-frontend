  ...
  export const actions = {
    async fetchInteractions({ commit, dispatch }, params) {
      return await this.$axios
        .get("/api/v1/prepaid/customer-interaction/", {
          params: params
        })
        .then(res => {
    ...
    async savePrepaidInteraction({ commit }, payload) {
      let url = "/api/v1/prepaid/customer-interaction/";
    ...
    async updateInteraction({ commit }, payload) {
      let url = `/api/v1/prepaid/customer-interaction/${payload.ticket_number}/`;
      let method = "put";
