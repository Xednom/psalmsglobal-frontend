...
export default {
  ...
  computed: {
     ...
     */
    ...mapGetters({
      otherCharges: "vodaconnect/otherCharge/otherCharges",
      pagination: "vodaconnect/otherCharge/otherChargesPagination"
    }),
    queriedData() {
  ...
  methods: {
    ...
    async fetchOtherCharges() {
      this.isBusy = true;
      try {
        await this.$store
          .dispatch(
            "vodaconnect/otherCharge/fetchOtherCharges",
            this.pagination
          )
          .then(() => {
            this.totalRows = this.otherCharges.length;
            this.isBusy = false;
          });
      } catch (e) {
