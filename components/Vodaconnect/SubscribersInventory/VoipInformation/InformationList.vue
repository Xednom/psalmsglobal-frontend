...
export default {
  ...
  computed: {
     ...
     */
    ...mapGetters({
      informations: "vodaconnect/voipInformation/voipInformations",
      pagination: "vodaconnect/voipInformation/voipInformationsPagination"
    }),
    queriedData() {
  ...
  methods: {
    ...
    async fetchVoipInformations() {
      this.isBusy = true;
      try {
        await this.$store
          .dispatch("vodaconnect/voipInformation/fetchVoipInformations", this.pagination)
          .then(() => {
