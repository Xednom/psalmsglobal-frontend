        ...
        <card card-body-classes="table-full-width">
          <div>
            <div class="card-header bg-transparent border-0">
              <h3 class="mb-0">Voip Information</h3>
            </div>
            <b-container fluid>
              <b-row>
              ...
              >
                ...
                <template #cell(status)="row">
                  <b-badge
                    ...
                    >Paid</b-badge
                  >
                  <b-badge variant="danger" v-else-if="!row.item.status">Unpaid</b-badge>
                </template>
...
export default {
  ...
  computed: {
     ...
     */
    ...mapGetters({
      subscriberStatuses: "vodaconnect/subscriberStatus/subscriberStatuses",
      pagination: "vodaconnect/subscriberStatus/subscriberStatusesPagination"
    }),
    queriedData() {
  ...
  methods: {
    ...
    async fetchSubscriberStatuses() {
      this.isBusy = true;
      try {
        await this.$store
          .dispatch("vodaconnect/subscriberStatus/fetchSubscriberStatuses", this.pagination)
          .then(() => {
            this.totalRows = this.subscriberStatuses.length;
            this.isBusy = false;
          });
      } catch (e) {
