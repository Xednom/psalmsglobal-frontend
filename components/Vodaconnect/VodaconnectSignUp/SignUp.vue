        ...
        <card card-body-classes="table-full-width">
          <div>
            <div class="card-header bg-transparent border-0">
              <h3 class="mb-0">Vodaconnect sign up</h3>
            </div>
            <b-container fluid>
              <b-row>
...
export default {
  ...
  computed: {
     ...
     */
    ...mapGetters({
      signUps: "vodaconnect/signUp/signUps",
      signUp: "vodaconnect/signUp/signUp",
      pagination: "vodaconnect/signUp/signUpsPagination"
    }),
    queriedData() {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "file_description", sortable: true },
  ...
  methods: {
    ...
    async fetchSignUps() {
      ...
      try {
        await this.$store
          .dispatch("vodaconnect/signUp/fetchSignUps", this.pagination)
          .then(() => {
            this.totalRows = this.signUps.length;
            this.isBusy = false;
          });
      } catch (e) {
