        ...
        <card card-body-classes="table-full-width">
          <div>
            <div class="card-header bg-transparent border-0">
              <h3 class="mb-0">Plan summary and payment</h3>
            </div>
            <b-container fluid>
              <b-row>
...
export default {
  ...
  computed: {
     ...
     */
    ...mapGetters({
      summaries: "vodaconnect/planSummary/summaries",
      pagination: "vodaconnect/planSummary/summariesPagination"
    }),
    queriedData() {
  ...
  methods: {
    ...
    async fetchSummaries() {
      ...
      try {
        await this.$store
          .dispatch("vodaconnect/planSummary/fetchSummaries", this.pagination)
          .then(() => {
