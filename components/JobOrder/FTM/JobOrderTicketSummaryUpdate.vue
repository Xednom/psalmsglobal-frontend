...
export default {
  ...
  methods: {
    ...mapActions("jobOrder", ["saveJobOrderTicketSummary"]),
    ...
    async save() {
      ...
      const jobOrderPayload = {
        ...
        ticket_summary_job_order: this.jobOrder.ticket_summary_job_order,
      ...
      try {
        if (this.accountType == "ftm") {
          this.saving = true;
          await this.saveJobOrderTicketSummary(jobOrderPayload);
          this.saving = false;
