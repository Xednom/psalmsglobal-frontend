      ...
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Ooops!</h1>
              <p class="text-lead text-white">Please try logging in to access the page.</p>

              <nuxt-link to="/login" class="font-weight-bold text-white mt-5">Back to login</nuxt-link>
            </div>
          </div>
        </div>
      </div>
